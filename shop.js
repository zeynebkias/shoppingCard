...
// syntax : let string = document.readyState; -----> MDN 
...
function updateCartTotal() {
    ...
    for (let i = 0; i < cartRows.length; i++) {
        ...
        let price = parseFloat(priceElement.innerText.replace('DA', ''))
...
const themeIcon = document.querySelector('.likeIt');
themeIcon.addEventListener('click',()=>{
    document.body.classList.toggle('light')    
    if(document.body.classList.contains('light')){
        themeIcon.src = 'https://img.icons8.com/windows/32/fa314a/like.png'
    }else{
        themeIcon.src = 'https://i.postimg.cc/HLP5fqBm/icons8-heart-24.png'
    }
